...
```{r}
detectar_outliers <- function(x, nombre_var = "Variable") {
  Q1 <- quantile(x, 0.25, na.rm = TRUE)
  Q3 <- quantile(x, 0.75, na.rm = TRUE)
  IQR <- Q3 - Q1
  ...
  # Boxplot
  boxplot(x, main = paste("Boxplot:", nombre_var), 
          ylab = "Valor", col = "steelblue")
  
  # QQplot
  qqnorm(x, main = paste("QQplot:", nombre_var))
